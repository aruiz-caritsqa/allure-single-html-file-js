...
const combineAllure = (_folder) => {
  const folder = resolve(_folder);
/**
 * Read all files,
 * create server.js,
 * then run server.js,
 */
  ...
  console.log(`> Folder to process is ${folder}; curDir is ${curDir}`);
  ...
  fs.copyFileSync(`${curDir}${sep}sinon-9.2.4.js`, `${folder}${sep}sinon-9.2.4.js`);
